...
namespace marketplus.Forms
{
    public partial class UrunListele : Form
    {
        ...
        private void UrunListele_MouseUp(object sender, MouseEventArgs e)
        {
            Mov = false;
        }

        private void UrunListele_MouseMove(object sender, MouseEventArgs e)
        {
            if (Mov)
            {
        ...
        private void UrunListele_MouseDown(object sender, MouseEventArgs e)
        {
            Mov = true;
            MovX = e.X;
            MovY = e.Y;

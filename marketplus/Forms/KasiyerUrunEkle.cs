...
{
    public partial class KasiyerUrunEkle : Form
    {
        public KasiyerUrunEkle()
        {
            InitializeComponent();
        }
        ...
        bool Mov;
        int MovX, MovY;
        private void KasiyerUrunEkle_MouseUp(object sender, MouseEventArgs e)
        {
            Mov = false;
        }

        private void KasiyerUrunEkle_MouseMove(object sender, MouseEventArgs e)
        {
            if (Mov)
            {
        ...
        private void KasiyerUrunEkle_MouseDown(object sender, MouseEventArgs e)
        {
            Mov = true;
            MovX = e.X;
            MovY = e.Y;

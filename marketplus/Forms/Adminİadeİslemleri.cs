...
{
    public partial class Adminİadeİslemleri : Form
    {
        public Adminİadeİslemleri()
        {
            InitializeComponent();
            LoadData();
        }
        ...
        private void Adminİadeİslemleri_Load(object sender, EventArgs e)
        {
        ...
        bool Mov;
        int MovX, MovY;
        private void Adminİadeİslemleri_MouseDown(object sender, MouseEventArgs e)
        {
            Mov = true;
            MovX = e.X;
            MovY = e.Y;
        ...
        private void Adminİadeİslemleri_MouseMove(object sender, MouseEventArgs e)
        {
            if (Mov)
            {
        ...
        private void Adminİadeİslemleri_MouseUp(object sender, MouseEventArgs e)
        {
            Mov = false;
        }
    }

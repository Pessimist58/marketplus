...
{
    public partial class AdminUrunArama : Form
    {
        public AdminUrunArama()
        {
            InitializeComponent();
        }
        ...
        private void txtBulunanUrun_TextChanged(object sender, EventArgs e)
        {
        ...
        private void AdminUrunArama_MouseUp(object sender, MouseEventArgs e)
        {
            Mov = false;
        }

        private void AdminUrunArama_MouseMove(object sender, MouseEventArgs e)
        {
            if (Mov)
            {
        ...
        private void AdminUrunArama_MouseDown(object sender, MouseEventArgs e)
        {
            Mov = true;
            MovX = e.X;
            MovY = e.Y;
